...
def optimize_k(iterations, len_data, X, Y):
    scores = []
    k = []
    std = []
    ...
    #print np.array(scores).mean(), np.array(scores).std(), len(scores)
...
def optimize_order(iterations, len_data, k, X, Y):
    scores_low = []
    order_low = []
    scores = []
    order = []
...
def get_scores(iterations, k,order, len_data, X,Y):
    scores = []
    std = []
    for cycle in range(iterations):
        cycle_scores = []
